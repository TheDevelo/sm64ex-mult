...
// ACTUALLY GREEN MWHAHAHAHAHA
static const Lights1 luigi_red_lights_group = gdSPDefLights1(
    0x00, 0x7f, 0x00,
...
// 0x04001890
ALIGNED8 static const u8 luigi_texture_m_logo[] = {
#include "actors/luigi/luigi_logo_custom.rgba16.inc.c"
};
...
const Gfx luigi_left_arm[] = {
    gsSPLight(&luigi_red_lights_group.l, 1),
    gsSPLight(&luigi_red_lights_group.a, 2),
...
const Gfx luigi_cap_on_eyes_front[] = {
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, luigi_texture_m_logo),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
UNUSED static const Lights1 luigi_lights_unused1 = gdSPDefLights1(
    0x3f, 0x30, 0x1e,
    0xfe, 0xc1, 0x79, 0x28, 0x28, 0x28
);

// Unreferenced light group
UNUSED static const Lights1 luigi_lights_unused2 = gdSPDefLights1(
    0x1c, 0x01, 0x00,
    0x73, 0x06, 0x00, 0x28, 0x28, 0x28
);
...
const Gfx luigi_medium_poly_left_leg_shared_dl[] = {
    gsSPVertex(luigi_medium_poly_left_leg_shared_dl_vertex, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  4, 0x0),
    gsSP2Triangles( 3,  4,  5, 0x0,  6,  5,  7, 0x0),
    gsSP2Triangles( 0,  7,  1, 0x0,  0,  8,  7, 0x0),
    gsSP2Triangles( 7,  8,  6, 0x0,  5,  6,  3, 0x0),
...
const Gfx luigi_medium_poly_right_leg_shared_dl[] = {
    gsSPVertex(luigi_medium_poly_right_leg_shared_dl_vertex, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
