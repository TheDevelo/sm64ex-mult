...
void read_controller_inputs(void) {
    ...
    if (gControllerBits) {
        ...
        osContGetReadData(gControllers[0].controllerData, 2);
        osContGetReadData(gControllers[1].controllerData, 1);
    }
    run_demo_inputs();
...
void setup_game_memory(void) {
    ...
    D_80339CF0[0] = main_pool_alloc(0x4000, MEMORY_POOL_LEFT);
    D_80339CF0[1] = main_pool_alloc(0x4000, MEMORY_POOL_LEFT);
    set_segment_base_addr(17, (void *) D_80339CF0[0]);
    set_segment_base_addr(17, (void *) D_80339CF0[1]);
    func_80278A78(&D_80339D10[0], gMarioAnims, D_80339CF0[0]);
    func_80278A78(&D_80339D10[1], gMarioAnims, D_80339CF0[1]);
